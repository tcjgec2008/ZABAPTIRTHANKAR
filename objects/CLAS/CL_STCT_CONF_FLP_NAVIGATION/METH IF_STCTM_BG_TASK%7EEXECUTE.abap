...
*****************************************
  ...
  IF i_check = 'X'.
    ...
    IF lv_cus = abap_true.
      ...
      " check NAVIGATION_GUI_INPLACE
      lv_property_id = 'NAVIGATION_GUI_INPLACE'.
      ...
      " check NAVIGATION_GUI_STATEFUL_CONTAINER
      lv_property_id = 'NAVIGATION_GUI_STATEFUL_CONTAINER'.
      lv_property_value = 'true'.
      ...
      " check NAVIGATION_WDA_INPLACE
      lv_property_id = 'NAVIGATION_WDA_INPLACE'.
      lv_property_value = 'true'.
  ...
  ELSE. "start execution
    ...
    IF lv_cus = abap_true.
      ...
      " conf NAVIGATION_GUI_STATEFUL_CONTAINER
      lv_property_id = 'NAVIGATION_GUI_STATEFUL_CONTAINER'.
      lv_property_value = 'true'.
